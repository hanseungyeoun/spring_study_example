...
public class QuerydslBasicTest {
    ...
    /**
     * 예) JPQL : select m, t from Member m left join m.team t on t.name = 'teamA'
     */
    @Test
    ...
    public void complexCase() {
        List<String> fetch = queryFactory
                .select(new CaseBuilder()
                        ...
                        .when(member.age.between(21, 30)).then("0-20")
                        .otherwise("기타")
                )
                .from(member)
                .fetch();
    ...
    @Test
    public void findDtaByQueryProjection(){
        List<MemberDto> fetch = queryFactory
    ...
    private BooleanExpression allEq(String usernameCond, Integer age) {
        return usernameEq(usernameCond).and(ageEq(age));
    }
